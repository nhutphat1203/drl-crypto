...
if __name__ == "__main__":
    ...
    for key, value in info.items():
        ...
        train_data = data[(data.index >= '2020-01-01') & (data.index < '2024-03-01')]
        eval_data = data[(data.index >= '2024-03-01') & (data.index < '2024-09-01')]
        test_data = data[(data.index >= '2024-09-01') & (data.index <= '2026-03-31')]
